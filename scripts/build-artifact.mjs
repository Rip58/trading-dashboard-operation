#!/usr/bin/env node
/**
 * Extrae el cuerpo de index.html a dist/terminal-confluencia.part.html.
 *
...
await writeFile(join(raiz, "dist", "terminal-confluencia.part.html"), fragmento, "utf8");
console.log(`fragmento: ${fragmento.length} B -> dist/terminal-confluencia.part.html`);
